...
module.exports = {
    ...
    run: async (message) => {
        ...
        const embed = new EmbedBuilder()
            ...
            .addFields(
                { name: 'Collection :flower_playing_cards:', value: '`Collection`, `View`, `Inventory`, `Burn`,`Viewlast`,`Tag`,`cardinfo`,`Multiburn`', inline: true },
                ...
                { name: 'Basic :book:', value: '`Cooldown`, `Drop`, `Daily`, `Shop`, `Frameshop`, `Vote`,`tags`,`tagcreate`,`tagdelete`,`Give`,`Misions`,`Morph`', inline: true },
